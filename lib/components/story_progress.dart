  ...
  static init() {
    gameStories = {
      StoryTitles.introArc.name: [
        MsgFormat(
            "Welcome to the GenGoal Chronicles, where every decision you make affects the world around you. Your choices have the power to preserve harmony in your environment or unleash chaos.",
